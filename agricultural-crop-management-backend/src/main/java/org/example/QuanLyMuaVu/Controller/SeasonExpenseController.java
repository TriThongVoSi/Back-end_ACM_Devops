...
public class SeasonExpenseController {
    ...
    public SeasonExpenseController(SeasonExpenseService seasonExpenseService) {
    ...
    @ApiResponses({
            ...
            @io.swagger.v3.oas.annotations.responses.ApiResponse(responseCode = "400", description = "Validation error or constraint violation"),
    ...
    @Operation(summary = "Get expense by ID", description = "Queries expense by ID for detail display.")
    @ApiResponses({
    ...
    @Operation(summary = "Delete expense", description = "Soft deletes expense after user confirms.")
    @ApiResponses({
    ...
    @Operation(summary = "List expenses", description = "List expenses with filters for current farmer.")
    @GetMapping("/expenses")
    ...
    @Operation(summary = "List expenses for a season", description = "Search expenses for a given season of the current farmer")
    ...
    @Operation(summary = "Budget tracker for season")
    ...
    @Operation(summary = "Expense analytics by category")
    ...
    @Operation(summary = "Expense analytics by task")
    ...
    @Operation(summary = "Expense analytics by vendor")
    ...
    @Operation(summary = "Expense analytics time series")
    ...
    public ResponseEntity<byte[]> exportExpenses(
        ...
        String filename = "expenses-" + (seasonId != null ? "season-" + seasonId + "-" : "") + suffix + ".csv";
    ...
    @Operation(summary = "Upload expense attachment")
    ...
    @Operation(summary = "Download expense attachment")
